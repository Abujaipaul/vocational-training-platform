...
export default function Hero(){
    ...
    return (
        <>
          <div className='flex flex-wrap max-sm:flex-col max-sm:items-center mt-2 mb-7 bg-slate-900 text-white'>
            ...
            <div className='w-1/2 h-screen max-sm:w-3/4 max-sm:h-160 '>
